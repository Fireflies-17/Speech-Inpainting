...
def get_kmeans_model(
    ...
    """Call the mini batch kmeans from sklearns.
    ...
    Args:
        ...
        max_no_improvement (_type_): _description_
        n_init (_type_): _description_
        reassignment_ratio (_type_): _description_
...
def train_kmeans(kmeans_model, features_batch):
    ...
    Args:
        ...
        features_batch (_type_): _description_
...
def main(args, logger):
    """Learns the clustering with kmeans model.
